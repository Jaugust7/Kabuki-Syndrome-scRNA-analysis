...
myUMAPPlotMarkers(dat.npc, markers=c("MAP2", "PAX6", "ASCL1", "HES5", "HES6", "DLL3")) + scale_color_gradient(low="gray95", high="red")
dev.off()

pdf("~/../../Volumes/Augustin/R Projects/10x_KS1_iPSC/umap_npc_progenitors.pdf", height = 10, width = 12)
myUMAPPlotMarkers(dat.npc, markers=c("MSI1", "SOX1", "ASCL1", "SOX2", "PAX6", "GFAP")) + scale_color_gradient(low="gray95", high="red")
dev.off()

pdf("~/../../Volumes/Augustin/R Projects/10x_KS1_iPSC/umap_npc_pseudotime_genes.pdf", height = 10, width = 12)
myUMAPPlotMarkers(dat.npc, markers=diff_test_npc_pseudotime_gene_names) + scale_color_gradient(low="gray95", high="red")
dev.off()

pdf("~/../../Volumes/Augustin/R Projects/10x_KS1_iPSC/umap_npc_cell_cycle.pdf", height = 10, width = 12)
myUMAPPlotMarkers(dat.npc, markers=c("CDK2", "PCNA", "SKP2", "CCND1", "GTSE1", "G2E3",  "WEE1", "PLK1", "RB1", "PCNA")) + scale_color_gradient(low="gray95", high="red")
dev.off()

myUMAPPlotMarkers(dat.npc, markers=c("HES1" ,"HES5", "MAP2", "DCX", "LIN28A", "SOX2", "HES6", "NEUROD1", "RBFOX3")) + scale_color_gradient(low="gray95", high="red")
...
myUMAPPlotMarkers(dat.npc, markers = c("LDHA", "ANXA2", "HIF1A", "VHL", "GPX1")) + scale_color_gradient(low="gray95", high = "red") 
dev.off()

pdf("~/../../Volumes/Augustin/R Projects/10x_KS1_iPSC/Residuals NPCs DCX expression.pdf", height = 10, width = 12)
myUMAPPlotMarkers(dat.mature, markers = c("DCX", "MAP2", "SNAP25", "HES6"), x_cord ="fitted", y_cord = "resid") + scale_color_gradient(low="gray95", high = "red") 
dev.off()
...
```{r NPC differential test for clustersr}
